    ...
    <div className='w-[500px] py-10 px-4 rounded-lg shadow-xl shadow-gray-900 flex flex-col items-center justify-center min-w-[290px] gap-2'>
      ...
      <form onSubmit={handleSubmit} className='w-[90%] flex flex-col gap-4'>
        ...
        <div className='w-full'>
          <Button type='submit' className='login-btn bg-sky-500 rounded-lg w-full p-2 hover:bg-sky-600 text-gray-300' disabled={loading} btnName={loading ? <span className='loading loading-spinner'></span> : "Login"} />
        </div>
      </form>
    </div>
  )
